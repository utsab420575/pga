                ...
                <div class="card-body">
                    <table class="table table-striped">
                      <tbody>
                        ...
                        <tr>
                          <td align="left">Step 1. If you don't have any applicant account then click <a href="{{URL::to('register')}}"><b>"Create Applicant Account"</b></a><br>Step 2. Then verify your contact number.<br>Step 3. To apply click "Apply Now", then provide all required information and click "Submit" button.</td>
                        </tr>
                        <tr>
                        ...
                        <td align="center"><br>Notice<br>
                            Admission Notice: <a href="{{ asset('public/notice.pdf') }}"><b>Download</b></a>
                          </td>
